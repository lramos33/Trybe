...
Copie os códigos **_HTML_** e **_CSS_** abaixo, salve-os no mesmo diretório com os nomes `index.html` e `style.css` , respectivamente;
```html
<!DOCTYPE html>
<html lang="pt-br">
  <head>
...
```
Para os seguintes exercícios você não precisará alterar o arquivo **_HTML_**, apenas o **_CSS_**. 😉
